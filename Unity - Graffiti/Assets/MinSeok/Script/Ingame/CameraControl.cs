...
public class CameraControl : MonoBehaviour
{
    ...
    void Awake()
    {
        obj_player = obj_redTeam[0] = GameObject.FindGameObjectWithTag(PlayerAttribute.instance.playerTag[0]);
        obj_redTeam[1] = GameObject.FindGameObjectWithTag(PlayerAttribute.instance.playerTag[1]);
        obj_blueTeam[0] = GameObject.FindGameObjectWithTag(PlayerAttribute.instance.playerTag[2]);
        obj_blueTeam[1] = GameObject.FindGameObjectWithTag(PlayerAttribute.instance.playerTag[3]);
