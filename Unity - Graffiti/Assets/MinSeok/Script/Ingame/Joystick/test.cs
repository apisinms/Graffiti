...
public class test : UnityEngine.MonoBehaviour, IDragHandler, IPointerUpHandler, IPointerDownHandler
{
    ...
    void Update()
    {
        ...
        if (start == true)
        {
            ...
            MyPlayerManager.instance.animePlayer.SetBool("idle_to_run", true);
          ...
          //  Debug.Log(direction);
            ...
            player2.transform.Translate(Vector3.right * 0.5f * (MyPlayerManager.instance.mySpeed) * Time.smoothDeltaTime * direction.x, Space.World);
            player2.transform.Translate(Vector3.forward * MyPlayerManager.instance.mySpeed * Time.smoothDeltaTime * direction.z, Space.World);
        }
        else
        {
            MyPlayerManager.instance.animePlayer.SetBool("idle_to_run", false);
        }
