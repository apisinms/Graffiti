...
#define START_SUCCESS_MSG			TEXT("시작에 성공했습니다.\n")
#define START_FAIL_MSG				TEXT("시작에 실패했습니다.\n")
...
class LobbyManager
{
	...
	{
		START_PROTOCOL = ((__int64)0x1 << 58),
		MATCHING_PROTOCOL = ((__int64)0x1 << 57),		// 매칭 프로토콜
	...
	enum RESULT_LOBBY : __int64
	{
		...
		START_SUCCESS = ((__int64)0x1 << 53),

		START_FAIL = ((__int64)0x1 << 52),
...
private:
	...
	bool StartProcess(C_ClientInfo* _ptr);
public:
	bool CanILeaveLobby(C_ClientInfo* _ptr);	// 로비로 갈 수 있는가
	bool CanIStart(C_ClientInfo* _ptr);
};