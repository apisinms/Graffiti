...
public partial class WeaponManager : MonoBehaviour
{
    ...
    public void ActionBullet_SG()
    {
        ...
        infoSG[myIndex].vt_bulletDir[0].x = infoSG[myIndex].tf_bulletClone[0].forward.x - (infoSG[myIndex].tf_bulletClone[0].right.x * 0.2f);
        infoSG[myIndex].vt_bulletDir[0].z = infoSG[myIndex].tf_bulletClone[0].forward.z - (infoSG[myIndex].tf_bulletClone[0].right.z * 0.2f);
        infoSG[myIndex].vt_bulletDir[1].x = infoSG[myIndex].tf_bulletClone[1].forward.x - (infoSG[myIndex].tf_bulletClone[1].right.x * 0.1f);
        infoSG[myIndex].vt_bulletDir[1].z = infoSG[myIndex].tf_bulletClone[1].forward.z - (infoSG[myIndex].tf_bulletClone[1].right.z * 0.1f);
        infoSG[myIndex].vt_bulletDir[2].x = infoSG[myIndex].tf_bulletClone[2].forward.x;
        infoSG[myIndex].vt_bulletDir[2].z = infoSG[myIndex].tf_bulletClone[2].forward.z;
        infoSG[myIndex].vt_bulletDir[3].x = infoSG[myIndex].tf_bulletClone[3].forward.x + (infoSG[myIndex].tf_bulletClone[3].right.x * 0.1f);
        infoSG[myIndex].vt_bulletDir[3].z = infoSG[myIndex].tf_bulletClone[3].forward.z + (infoSG[myIndex].tf_bulletClone[3].right.z * 0.1f);
        infoSG[myIndex].vt_bulletDir[4].x = infoSG[myIndex].tf_bulletClone[4].forward.x + (infoSG[myIndex].tf_bulletClone[4].right.x * 0.2f);
        infoSG[myIndex].vt_bulletDir[4].z = infoSG[myIndex].tf_bulletClone[4].forward.z + (infoSG[myIndex].tf_bulletClone[4].right.z * 0.2f);
    ...
    public void ActionBullet_SMG()
    {
        ...
        clone.GetComponent<Rigidbody>().AddForce(infoSMG[myIndex].vt_bulletPattern[infoSMG[myIndex].bulletPatternIndex] * 2000.0f, ForceMode.Acceleration);
